 ...
 */
export const taskProcessingInfoMessages = {
    STARTING_TASK: 'Starting to process task ',
    PROCESSING_IMAGE: 'Processing image...',
    PROCESSING_RESOLUTION: 'Processing resolution...',
    PROCESSED_RESOLITION: 'Resolution processed successfully.',
 ...
 * Error messages
 */
export const taskProcessingErrorMessages = {
